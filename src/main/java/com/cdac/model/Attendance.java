...
/*
 *  create table db_student_attendance(student_id varchar(40),subject_id varchar(40),total_class int(3),
class_attended int(3),percent float(3),primary key (student_id,subject_id));
 * */
@Entity
